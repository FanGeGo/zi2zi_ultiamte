...
outputDoc='E:\UbuntuWorkspace\zi2zi\experiment11\FontImage4_6763withParts';
...
for i=1:size(csvFile,1)
    ...
    canvas=ones(256,512,3)*255;
    for j=1:3
        %canvas(:,1:256,j)=imgTarget;
        canvas(:,257:512,j)=imgSource;
    end
    
    imgNameOutput=sprintf('%d_%s.jpg',label,num2str(counter,'%05d'));
